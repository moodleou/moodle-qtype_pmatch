...
$string['converttospace_help'] = 'Sepcify characters that you want the system to ignore by converting them to spaces. This will simplify the respondents input before pattern-matching. This is great for simplifying the marking of input when punctuatuion does not matter.';
...
$string['sentencedividers'] = 'Treat the following characters as sentence dividers';
$string['sentencedividers_help'] = 'Specify characters for the system to automatically treat as the end point for sentences. If require pattern-matching on these characters, you will need to remove them from this field and escape them in Answer Matching section by using \\. E.g. to match Whos there? with the default settings (which include \'?\'), you would enter: match(whos there\?). However, the \'.\' and \'!\' do not need escaping.';
