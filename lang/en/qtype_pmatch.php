...
$string['filloutoneanswer'] = 'Use pattern match to syntax to describe possible answers. The student\'s response will be compared to these in order, and the first matching pattern will determine the score and the feedback. You must give at least one pattern.';
