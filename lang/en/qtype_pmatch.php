...
$string['processingxofy'] = 'Processing response {$a->row} of {$a->total}.';
...
$string['testquestionactualmark'] = 'Actual mark';
$string['testquestionexpectedmark'] = 'Expected mark';
...
$string['testquestionresultssummary'] = 'Marked correctly: <b>{$a->correct}</b>, incorrectly marked wrong <b>{$a->incorrectlymarkedwrong}</b>, incorrectly marked right <b>{$a->incorrectlymarkedright}</b>.';
