...
$string['testquestionincorrectlymarkedwrong'] = 'incorrectly marked wrong';
$string['testquestionincorrectlymarkedrights'] = 'incorrectly marked right';
...
$string['testquestionuploadrowhastwoitems'] = 'Each row should contain exactly two items, a numerical mark and a response. Row <b>{$a->row}</b> contains <b>{$a->items}</b> items.';
...
$string['testquestionuploadexpectedfractionnull'] = 'The expected mark in row <b>{$a}</b> is empty. The input must be a number.';
